...
* A reward of 1 is given if the correct cup is touched and no other cups are touched, and a reward
* of 2 and terminal is given when the ball itself is touched and no incorrect cups are touched.
*/
