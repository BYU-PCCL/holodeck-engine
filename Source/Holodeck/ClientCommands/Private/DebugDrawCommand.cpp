...
void UDebugDrawCommand::Execute() {
	...
	*/
	FVector Vec1 = FVector(NumberParams[1], NumberParams[2], NumberParams[3]) * UnitsPerMeter;
	FVector Vec2 = FVector(NumberParams[4], NumberParams[5], NumberParams[6]) * UnitsPerMeter;
