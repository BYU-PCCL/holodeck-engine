...
bool AUAV::Teleport_Implementation(const FVector& NewLocation) {
	FRotator DefaultRotation = this->GetActorRotation();
	return TeleportAndRotate(NewLocation, DefaultRotation);
}

bool AUAV::TeleportAndRotate_Implementation(const FVector& NewLocation, FRotator NewRotation) {
...
bool AUAV::InitializeController_Implementation() {
...
FString AUAV::GetAgentName_Implementation() {
	return AgentName;
}

bool AUAV::SetAgentName_Implementation(const FString& Name) {
	AgentName = Name;
	return true;
}

bool AUAV::SpawnController_Implementation() {
	// TODO add functionality
	SpawnDefaultController();
	return true;
}

AHolodeckPawnController* AUAV::GetHolodeckPawnController_Implementation() {
	return PawnController;
}

bool AUAV::SetHolodeckPawnController_Implementation(AHolodeckPawnController* HolodeckController) {
	PawnController = HolodeckController;
	return true;
}

bool AUAV::SetTerminal_Implementation(bool Terminal) {
	if (TerminalPtr != nullptr) {
...
bool AUAV::SetReward_Implementation(int Reward) {
	if (RewardPtr != nullptr) {
		*RewardPtr = Reward;
		return true;
	} else {
